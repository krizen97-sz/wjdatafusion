...
从旧版升级到 `v3.16.2` 时，执行 `WDF100.0/sql/support_upgrade_20260829_auto_inspection_daily_history_fix_v3_16_2.sql`。脚本只修正有“首次采样基线”或“重新建立基线”证据的旧高频记录，并重算受影响日期的健康度；普通跳过、失败、异常和例行巡检记录不会被修改。
