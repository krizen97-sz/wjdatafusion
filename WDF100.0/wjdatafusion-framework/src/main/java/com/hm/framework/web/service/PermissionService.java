...
import com.hm.framework.security.context.PermissionContextHolder;
...
public class PermissionService
{
    ...
    {
        String trimPermission = StringUtils.trim(permission);
        return permissions.contains(Constants.ALL_PERMISSION)
            || permissions.contains(trimPermission)
            || (trimPermission != null && trimPermission.startsWith("support:") && permissions.contains("datafusion"));
    }
}
