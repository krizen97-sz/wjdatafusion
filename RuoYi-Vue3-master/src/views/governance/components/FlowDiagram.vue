...
.flow-node.is-selected .flow-node__tile, .flow-node:focus-visible .flow-node__tile, .flow-node.is-link-source .flow-node__tile { border-color: var(--el-color-primary); background: var(--el-fill-color); outline: 2px solid var(--el-color-primary); outline-offset: 2px; }
