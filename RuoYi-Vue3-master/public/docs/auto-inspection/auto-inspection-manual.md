...
接口调用测试配置页按页签填写，页面只保留短提示，主要包含：

| 配置区 | 说明 |
| --- | --- |
| 请求信息 | 填接口名称、GET/POST、URL 和 HTTPS 证书校验方式 |
| 参数与鉴权 | 填 Query、Header、Cookie、鉴权方式和请求体；敏感值保存为密文 |
| 返回条件 | 配置状态码、耗时、JSON 字段、列表数量、返回内容和返回 Header |
