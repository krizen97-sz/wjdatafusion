...
public final class KettleWorker {
  ...
  public static void main(String[] args) {
    ...
    try{root=Paths.get(args[0]);String operation=args[1];installControlBridge();
      ...
      else if(operation.equals("job")||operation.equals("job-validate")||operation.equals("job-load")){Class.forName("NativeJobExecutor").getMethod(operation.equals("job")?"run":"validate",Path.class).invoke(null,root);}
