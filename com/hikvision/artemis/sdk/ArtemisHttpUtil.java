...
public class ArtemisHttpUtil {
     ...
     * @param header
     */
    public static String doGetArtemis(ArtemisConfig artemisConfig, Map<String, String> path, Map<String, Object> querys, String accept, String contentType, Map<String, String> header) throws Exception {
        /**
    ...
    public static String doGetArtemis(ArtemisConfig artemisConfig, Map<String, String> path, Map<String, Object> querys, String accept, String contentType) throws Exception {
     ...
     */
    public static Response doGetResponse(ArtemisConfig artemisConfig, Map<String, String> path, Map<String, Object> querys, String accept, String contentType, Map<String, String> header) throws Exception {
        /**
         * 根据传入的path获取是请求是http还是https
         */
        String httpSchema = (String) path.keySet().toArray()[0];
     ...
     */
    public static Response doPostStringImgArtemis(ArtemisConfig artemisConfig, Map<String, String> path, String body,
                                                      Map<String, String> querys, String accept, String contentType, Map<String, String> header) throws Exception {
        /**
         * 根据传入的path获取是请求是http还是https
         */
     ...
     * @return  POST json请求类型图片下载接口  HttpResponse类型
     */
    public static Response doPostDownloadFileArtemis(ArtemisConfig artemisConfig, Map<String, String> path, String body,
                                                  Map<String, String> querys, String accept, String contentType, Map<String, String> header) throws Exception {
        /**
         * 根据传入的path获取是请求是http还是https
         */
        ...
        Request request = new Request(Method.POST_DOWNLOAD, httpSchema + artemisConfig.getHost(),
                path.get(httpSchema), artemisConfig.getAppKey(), artemisConfig.getAppSecret(), Constants.DEFAULT_TIMEOUT);
        request.setHeaders(headers);
        //请求的query
        request.setQuerys(querys);
