...
is_module_path() {
  ...
  case "$module:$path" in
    ...
    site-fusion:*support/site/*|site-fusion:*support/server/*|site-fusion:*support/equipment.js|site-fusion:docs/site-fusion/*|site-fusion:*SupportSite*|site-fusion:*SupportServer*|site-fusion:*SupportHardware*|site-fusion:*SupportEquipment*|site-fusion:*equipmentLocation*|site-fusion:*EquipmentLocation*|site-fusion:*equipment_location*|site-fusion:*hardware_asset*|site-fusion:*server_credential*) return 0 ;;
