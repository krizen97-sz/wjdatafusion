...
is_module_path() {
  ...
  path=$2
  case "$module:$path" in
    platform-ui:DESIGN.md|platform-ui:docs/KEYLINE_ICONS.md|platform-ui:docs/frontend/*|platform-ui:.agents/skills/ruoyi-element-plus-ui/*|platform-ui:RuoYi-Vue3-master/README.md|platform-ui:RuoYi-Vue3-master/index.html|platform-ui:RuoYi-Vue3-master/vite.config.js|platform-ui:RuoYi-Vue3-master/scripts/import-keyline-icons.mjs|platform-ui:RuoYi-Vue3-master/scripts/check-browser-compat.mjs|platform-ui:RuoYi-Vue3-master/scripts/ui-guard.mjs|platform-ui:RuoYi-Vue3-master/scripts/ui-guard-allowlist.json|platform-ui:RuoYi-Vue3-master/scripts/__tests__/browser-compat.test.mjs|platform-ui:RuoYi-Vue3-master/scripts/__tests__/ui-guard.test.mjs|platform-ui:RuoYi-Vue3-master/src/main.js|platform-ui:RuoYi-Vue3-master/src/polyfills/*|platform-ui:RuoYi-Vue3-master/src/assets/icons/*|platform-ui:RuoYi-Vue3-master/src/assets/styles/*|platform-ui:RuoYi-Vue3-master/src/components/*|platform-ui:RuoYi-Vue3-master/src/layout/*|platform-ui:RuoYi-Vue3-master/src/plugins/download.js|platform-ui:RuoYi-Vue3-master/src/plugins/modal.js|platform-ui:RuoYi-Vue3-master/src/utils/iconRegistry.js|platform-ui:RuoYi-Vue3-master/src/utils/platformLoading.js|platform-ui:RuoYi-Vue3-master/src/utils/request.js|platform-ui:RuoYi-Vue3-master/src/utils/routeProgress.js|platform-ui:RuoYi-Vue3-master/src/views/*) return 0 ;;
    ...
    site-fusion:*support/site/*|site-fusion:*support/server/*|site-fusion:*support/server.js|site-fusion:*support/hardwareAsset.js|site-fusion:*support/equipment.js|site-fusion:docs/site-fusion/*|site-fusion:*SupportSite*|site-fusion:*SupportServer*|site-fusion:*SupportHardware*|site-fusion:*SupportEquipment*|site-fusion:*equipmentLocation*|site-fusion:*EquipmentLocation*|site-fusion:*equipment_location*|site-fusion:*hardware_asset*|site-fusion:*server_credential*) return 0 ;;
