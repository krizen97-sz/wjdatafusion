...
is_module_path() {
  ...
  path=$2
  case "$module:$path" in
    platform-ui:DESIGN.md|platform-ui:docs/KEYLINE_ICONS.md|platform-ui:docs/frontend/*|platform-ui:.agents/skills/ruoyi-element-plus-ui/*|platform-ui:RuoYi-Vue3-master/README.md|platform-ui:RuoYi-Vue3-master/scripts/import-keyline-icons.mjs|platform-ui:RuoYi-Vue3-master/scripts/ui-guard.mjs|platform-ui:RuoYi-Vue3-master/scripts/ui-guard-allowlist.json|platform-ui:RuoYi-Vue3-master/scripts/__tests__/ui-guard.test.mjs|platform-ui:RuoYi-Vue3-master/src/assets/icons/*|platform-ui:RuoYi-Vue3-master/src/components/IconSelect/*|platform-ui:RuoYi-Vue3-master/src/components/SvgIcon/*|platform-ui:RuoYi-Vue3-master/src/utils/iconRegistry.js|platform-ui:RuoYi-Vue3-master/src/views/system/menu/index.vue) return 0 ;;
